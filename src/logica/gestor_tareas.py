...
class GestorTareasGUI:
    def __init__(self, root, gestor):
        ...
        # Etiquetas para el título y descripción
        self.titulo_label = ttk.Label(self.frame, text="Título:")
        self.titulo_label.grid(row=0, column=0, sticky=tk.W)

        self.descripcion_label = ttk.Label(self.frame, text="Descripción:")
        self.descripcion_label.grid(row=1, column=0, sticky=tk.W)
        ...
        self.agregar_btn.grid(row=1, column=2, sticky=tk.W)
